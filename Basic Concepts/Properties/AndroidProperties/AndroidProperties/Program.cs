...
namespace CellProperties
{
    ...
    /*
    [Application(Label = "AndroidProperties", Icon = "@drawable/icon")]
    public class CellSDKApplication : Android.App.Application
    {
        /// <summary>
        /// Replace APP_PACKAGE value with your own C2DM package
        /// </summary>
        public const string APP_PACKAGE = "AndroidProperties.AndroidProperties";
    ...
    */
    ...
    [Activity(Label = "AndroidProperties", MainLauncher = true, Icon = "@drawable/icon",

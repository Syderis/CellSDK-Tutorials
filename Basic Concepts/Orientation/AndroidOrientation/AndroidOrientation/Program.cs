...
namespace Orientation
{
    ...
    /*
    [Application(Label = "AndroidOrientation", Icon = "@drawable/icon")]
    public class CellSDKApplication : Android.App.Application
    {
        /// <summary>
        /// Replace APP_PACKAGE value with your own C2DM package
        /// </summary>
        public const string APP_PACKAGE = "AndroidOrientation.AndroidOrientation";
    ...
    */
    ...
    [Activity(Label = "AndroidOrientation", MainLauncher = true, Icon = "@drawable/icon",

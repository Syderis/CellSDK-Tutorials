...
namespace CellResources
{
    ...
    /*
    [Application(Label = "AndroidResourceManager", Icon = "@drawable/icon")]
    public class CellSDKApplication : Android.App.Application
    {
        /// <summary>
        /// Replace APP_PACKAGE value with your own C2DM package
        /// </summary>
        public const string APP_PACKAGE = "AndroidResourceManager.AndroidResourceManager";
    ...
    */
    ...
    [Activity(Label = "AndroidResourceManager", MainLauncher = true, Icon = "@drawable/icon",

...
namespace LocalizedStrings
{
    ...
    /*
    [Application(Label = "AndroidLocalizedStrings", Icon = "@drawable/icon")]
    public class CellSDKApplication : Android.App.Application
    {
        /// <summary>
        /// Replace APP_PACKAGE value with your own C2DM package
        /// </summary>
        public const string APP_PACKAGE = "AndroidLocalizedStrings.AndroidLocalizedStrings";
    ...
    */
    ...
    [Activity(Label = "AndroidLocalizedStrings", MainLauncher = true, Icon = "@drawable/icon")]

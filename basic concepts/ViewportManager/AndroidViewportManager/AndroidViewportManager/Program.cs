...
namespace ViewportManager
{
    ...
    /*
    [Application(Label = "AndroidViewportManager", Icon = "@drawable/icon")]
    public class CellSDKApplication : Android.App.Application
    {
        /// <summary>
        /// Replace APP_PACKAGE value with your own C2DM package
        /// </summary>
        public const string APP_PACKAGE = "AndroidViewportManager.AndroidViewportManager";
    ...
    */
    ...
    [Activity(Label = "AndroidViewportManager", MainLauncher = true, Icon = "@drawable/icon",

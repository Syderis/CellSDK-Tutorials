...
namespace CellSprites
{
    ...
    /*
    [Application(Label = "AndroidSprites", Icon = "@drawable/icon")]
    public class CellSDKApplication : Android.App.Application
    {
        /// <summary>
        /// Replace APP_PACKAGE value with your own C2DM package
        /// </summary>
        public const string APP_PACKAGE = "AndroidSprites.AndroidSprites";
    ...
    */
    ...
    [Activity(Label = "AndroidSprites", MainLauncher = true, Icon = "@drawable/icon",

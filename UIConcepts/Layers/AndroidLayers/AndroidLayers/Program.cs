...
namespace CellLayers
{
    ...
    /*
    [Application(Label = "AndroidLayers", Icon = "@drawable/icon")]
    public class CellSDKApplication : Android.App.Application
    {
        /// <summary>
        /// Replace APP_PACKAGE value with your own C2DM package
        /// </summary>
        public const string APP_PACKAGE = "AndroidLayers.AndroidLayers";
    ...
    */
    ...
    [Activity(Label = "AndroidLayers", MainLauncher = true, Icon = "@drawable/icon",
